...
import com.origintech.calculator3.Page.LargePanel;
import com.origintech.calculator3.Page.NormalPanel;
import com.origintech.calculator3.Page.SmallPanel;
import com.origintech.calculator3.view.CalculatorDisplay;
import com.origintech.calculator3.view.CalculatorViewPager;
import com.origintech.calculator3.view.Cling;
import com.origintech.calculator3.view.HistoryLine;
...
public class Calculator extends BaseActivity implements Logic.Listener, OnClickListener, OnMenuItemClickListener, CalculatorViewPager.OnPageChangeListener {
    ...
    public void onCreate(Bundle state) {
        ...
        Theme.buildResourceMap(com.origintech.calculator3.R.class);
        Theme.setPackageName(CalculatorSettings.getTheme(getContext()));
        Theme.setPackageOverride("com.origintech.calculator3");
